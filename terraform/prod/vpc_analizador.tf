...
#   # Permitir tráfico UDP desde el mirror target
#   ingress {
#     from_port       = 0
#     to_port         = 65535
#     protocol        = "udp"
#     security_groups = [aws_security_group.mirror_target.id]
#     description     = "UDP traffic from mirror target"
#   }
...
#   # Permitir VXLAN UDP 4789 desde NLB
#   ingress {
#     from_port   = 4789
#     to_port     = 4789
#     protocol    = "udp"
#     cidr_blocks = ["0.0.0.0/0"]
#     description = "VXLAN traffic from NLB"
#   }
...
# # ========================================
# # NLB (interno) para recibir VXLAN (UDP/4789)
# # ========================================
...
#         { containerPort = 4789, protocol = "udp" } # <— clave
#       ]
#     }
#   ])
...
#   # Esta asociación hace que ECS agregue/quitar la IP del task al TG UDP/4789 automáticamente
#   load_balancer {
#     target_group_arn = aws_lb_target_group.vxlan_tg.arn
#     container_name   = "sensor" # Debe coincidir con el nombre en container_definitions
#     container_port   = 4789
#   }
...
# # ========================================
# # SECURITY GROUP RULES - UDP 4789
# # ========================================

# # Regla adicional para UDP 4789 en el security group ECS
# resource "aws_security_group_rule" "ecs_mirror_udp_4789" {
#   type              = "ingress"
#   security_group_id = aws_security_group.ecs_mirror.id
#   from_port         = 4789
#   to_port           = 4789
#   protocol          = "udp"
#   cidr_blocks       = ["0.0.0.0/0"] # Para demo. En prod, limitar a rangos del/los clientes o VPC peered.
#   description       = "VXLAN/UDP4789 hacia el task (vía NLB)"
# }
...
# # Traffic Mirror Target que apunta al NLB
