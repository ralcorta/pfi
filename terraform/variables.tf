...
variable "vpc_1_public_subnet_cidr" {
  description = "CIDR block para la subnet pública de VPC 1"
  type        = string
  default     = "10.0.1.0/24"
}
...
variable "vpc_2_public_subnet_cidr" {
  description = "CIDR block para la subnet pública de VPC 2 (Cliente)"
  type        = string
  default     = "10.1.1.0/24"
}
...
variable "enable_public_access" {
  description = "Habilitar acceso público al sensor (para demos)"
  type        = bool
  default     = false
}
