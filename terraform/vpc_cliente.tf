...
#   description = "Traffic filter for client - TCP only"
...
# # NOTA: Traffic Mirror Session deshabilitado temporalmente
# # Se requiere una instancia EC2 adjunta al ENI para funcionar
# # 
# # # Traffic Mirror Target para el analizador
# # resource "aws_ec2_traffic_mirror_target" "analizador_target" {
# #   network_interface_id = aws_network_interface.mirror_target.id
# #   
# #   tags = {
